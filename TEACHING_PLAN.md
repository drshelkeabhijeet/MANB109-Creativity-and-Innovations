# Teaching Plan — MANB109 Creativity and Innovations

15 weekly studio sessions · 120 minutes each · 30 contact hours · 3 units × 5 sessions

Each unit runs the same arc: **concept → guided practice → independent application →
the prescribed hands-on activity → consolidation and pitch.** The prescribed activity always
lands in session 4 of its unit, so students meet it with three sessions of practice behind
them rather than cold.

Every session closes with a pitch. `109.2` is therefore in scope in all 15.
...
|---|---|---|---|
| 1 | What Creativity Is, and Why Your Ideas Get Stuck | Worst-possible-idea warm-up; creativity vs innovation; the four barriers. **Anchor enterprise selected**; twenty questions written for its owner | 109.1, 109.2 |
...
| CO | Sessions | Count |
|---|---|---|
| 109.1 Understand foundations | 1–5 | 5 |
| 109.2 Present using storytelling and visual tools | 1–15 | 15 |
| 109.3 Use SCAMPER | 11–15 | 5 |
| 109.4 Apply mind mapping | 6–10 | 5 |

`109.2` is carried by the closing pitch in every session — the attainment path for a CO no
unit's topics cover.

## The three prescribed activities

All three appear verbatim, each in session 4 of its unit:

| Unit | Session | Prescribed activity |
|---|---|---|
